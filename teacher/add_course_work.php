                                    ...
                                    <div class="row">
                                        <div class="col-lg-2 col-md-2 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <?php
                                                $teacher_data = mysqli_query($conn, 'SELECT * FROM lmstealmsr where status="1" AND tid= ' . $_SESSION['tid'] . '  Limit 1');
                                                if ($teacher_data) {
                                                    $teacher_data_result = mysqli_fetch_array($teacher_data);
                                                }

                                                ?>
                                                <input type="text" placeholder="<?php echo $teacher_data_result['fullname']; ?>" class="form-control" name="tid" readonly required>
                                                <input type="hidden" value="<?php echo $_SESSION['tid']; ?>" class="form-control" name="tid" readonly required>
                                            </div>
                                        </div>
