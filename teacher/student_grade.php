    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        <div class="content-body bg-lblue">
			...
			INNER JOIN lmssubject ON lmstealmsr_multiple.tealmsr_contain_id = lmssubject.class_id
			WHERE lmstealmsr_multiple.tealmsr_type = 2 AND lmstealmsr.tid=$_SESSION[tid]";
                                                    $results = mysqli_query($conn, $query);
                                                    $row_count = mysqli_num_rows($results);


                                                    while ($row = mysqli_fetch_array($results)) {
                                                        echo "<tr><td><a href='group_chat.php?gid=" . ($row['class_id']) . "'>" . ($row['name']) . "</a></td></tr>";
                                                    }
