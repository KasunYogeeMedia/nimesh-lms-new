            ...
            <div class="collapse navbar-collapse" id="edumint_main_menu">
                <ul class="navbar-nav menu-open">
                    ...
                    <ul class="mobile-btn float-right">
                        <li>
                            <a class="loginlink" href="user_direct.php" >Login</a>
                        </li>
                        <li>
                            <a class="registerlink" href="register.php" style="padding: 7px 30px; background: var(--main-color); border-radius:25px;">Register</a>
                        </li>
                    </ul>
                </ul>
            </div>
