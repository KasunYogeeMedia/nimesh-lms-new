            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="single-quote-inner">
                        <div class="thumb text-right">
                            <img src="assets/img/about/Announcing.jpg" alt="img">
                        </div>
                        <div class="details">
                ...
                <div class="col-lg-8 pd-top-90">
                    ...
                    <div class="block-area">
                        <div class="row">
                            <div class="col-md-6">
                                <div class="single-block-inner" style="background-image: url('assets/img/other/CONSULTANT.jpg');">
                                    <span>CONSULTANT -TRAINING AND</span>
                                    <h4> Skill Development</h4>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="single-block-inner" style="background-image: url('assets/img/other/EnglishCourse2.jpg');">
                                    <span>Bussiness</span>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="thumb about-thumb  wow animated zoomIn" data-wow-duration="0.8s" data-wow-delay="0.4s">
                                <img src="assets/img/about/about4.jpg" alt="img">
                            </div>
                        </div>
                    </div>
                </div>
...
<!--                             <span class="price">17500</span> -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-course-inner">
                        <div class="thumb">
                            <img src="assets/img/course/EnglishCourse.jpg" alt="img">
                            <div class="cat-area">
                            </div>
                        </div>
                        <div class="details">
<!--                             <span class="price">$60</span> -->
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="single-course-inner">
                        <div class="thumb">
                            <img src="assets/img/course/Media.jpg" alt="img">
                            <div class="cat-area">
                            </div>
                        </div>
                        <div class="details">
<!--                             <span class="price">$90</span> -->
      ...
      <div class="course-area pd-top-20 pd-bottom-120">
        ...
        <div class="text-center">
            ...
            <?php
                ...
                // The SQL query
                $list_query = "SELECT * FROM lmsclass_schlmsle WHERE classtype = 'Free Class' AND add_date2 <= '2023-07-31'";
                ...
                if (mysqli_num_rows($list_result) > 0) {
                    while ($list_row = mysqli_fetch_assoc($list_result)) {
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="single-course-inner">
                                <div class="thumb">
                                    <img src="admin/image/<?php echo $list_row['image'];?>" alt="img">
                                </div>
                                <div class="details">
                                    <div class="details-inner">
    ...
    <script src="assets/js/counter_main.js"></script>
    <!-- main js  -->
