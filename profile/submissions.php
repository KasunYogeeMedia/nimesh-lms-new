							...
							<div class="table-responsive mt-30">
								<table id="dataTable" class="table table-striped table-bordered nowrap" style="width:100%">
									...
									<tbody>
										...
										<?php
										$cont = 0;
										$list_qury = mysqli_query($conn, "SELECT e.exid,s.name sname,e.examname,e.edate,e.exam_end_date,e.starttime,e.endtime FROM lmsonlineexams e LEFT JOIN lmssubject c ON e.subject=c.sid LEFT JOIN lmssubject s on e.subject=s.sid ORDER BY e.exid DESC");
